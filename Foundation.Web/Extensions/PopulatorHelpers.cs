...
namespace Foundation.Web.Extensions
{
    ...
    {
        public static IEnumerable<SelectListItem> CreateDropDownList<T>(this IEnumerable<T> source,
            Func<T, string> textPropertySelector, Func<T, object> valuePropertySelector, object value = null)
        {
            return source
        ...
        public static IEnumerable<SelectListItem> CreateDropDownList<T>(this ISession session,
            Func<T, string> textPropertySelector, Func<T, object> valuePropertySelector, object value = null)
        {
