...
namespace Foundation.Web.Caching
{
    ...
    public interface ICacheService
    {
        ...
        /// <returns>Return the object of time T either from the cache or from the callback query. </returns>
        T Get<T>(string cacheId, CacheType type, Func<T> getItemCallback, CacheItemPriority priority)
        ...
        T Get<T>(string cacheId, CacheType type, Func<T> getItemCallback, int secondsToCache, CacheItemPriority priority)
            where T : class, IFlushable;
