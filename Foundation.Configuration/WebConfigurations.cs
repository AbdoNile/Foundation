...
namespace Foundation.Configuration
{
    public class WebConfigurations : IResourcesLocator
    {
        ...
        /// <summary>
        ///     Resource manager for page titles. the key in the resource file should be the name of the view model omitting the
        ///     suffix "ViewModel" if it exists.
        /// </summary>
        ...
        /// <summary>
        ///     Resource manager for help content. the key in the resource file should follow the following format
        ///     ViewModelTypeName_ElementName.
        /// </summary>
